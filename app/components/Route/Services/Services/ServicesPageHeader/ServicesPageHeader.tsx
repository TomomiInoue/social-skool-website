    ...
    return (
        <div className={cn("flex flex-col lg:flex-row gap-10 lg:gap-[120px] justify-center items-center")}>
            <div className="flex-col lg:max-w-[420px]">
                <h4 className="oswald text-[32px] font-bold mb-4 sm:mb-8 lg:mb-[70px]">{title}</h4>
                <p className="text-base pb-5">
                    {description}
                </p>
                <Link href="/services-page" className="text-burgundy flex gap-2 text-sm items-center">
